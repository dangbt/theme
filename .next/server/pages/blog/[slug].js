...
function BlogDetailComponent({ blog  }) {
    const { 0: logo , 1: name , 2: description , 3: createdAt , 4: username  } = (0,external_react_.useMemo)(()=>[
            ...
            (0,get_data/* getDataFromObject */.l)(blog, "attributes.description"),
...
const getServerSideProps = async (context)=>{
    ...
    if (params && params.slug) {
        promise.push((0,fetcher/* getBlogDetail */.lK)(params.slug));
    }
    const [layout, tags, categories, blogs] = await Promise.all(promise);
    const blog = blogs.data[0];
    const metaTag = {
        siteName: `${(0,get_data/* getDataFromObject */.l)(blog, "attributes.name")}`,
        url: `/blog/${(0,get_data/* getDataFromObject */.l)(blog, "attributes.slug")}`,
        title: `${(0,get_data/* getDataFromObject */.l)(blog, "attributes.name")}`,
        description: (0,get_data/* getDataFromObject */.l)(blog, "attributes.sort_description"),
        publishedTime: (0,get_data/* getDataFromObject */.l)(blog, "attributes.publishedAt"),
        modifiedTime: (0,get_data/* getDataFromObject */.l)(blog, "attributes.updatedAt"),
        image: (0,get_data/* getDataFromObject */.l)(blog, "attributes.thumnail.data.attributes.formats.small.url"),
        publisher: (0,get_data/* getDataFromObject */.l)(blog, "attributes.users_permissions_user.data.attributes.username")
    };
...
var __webpack_exports__ = __webpack_require__.X(0, [676,61,337,274,812], () => (__webpack_exec__(8054)));
